 ...
 * 
 */
@WebServiceClient(name = "GreetingImplService", targetNamespace = "http://WSimport.zakir/", wsdlLocation = "http://localhost:8090/Greeting?wsdl")
    ...
    extends Service
{
    ...
    private final static QName GREETINGIMPLSERVICE_QNAME = new QName("http://WSimport.zakir/", "GreetingImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/Greeting?wsdl");
    ...
    public Greeting getGreetingImplPort() {
        return super.getPort(new QName("http://WSimport.zakir/", "GreetingImplPort"), Greeting.class);
    }
    ...
    public Greeting getGreetingImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WSimport.zakir/", "GreetingImplPort"), Greeting.class, features);
    }
